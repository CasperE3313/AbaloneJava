...
public class Game2P extends Game {
    ...
    /**
     * The constructor for Game2P.
     * 
     * @requires s0 != null && s1 != null
     * @invariant s0 and s1 are never null
     * @param s0 Player
     * @param s1 Player
     */ 
     ...
     * @ensures true is returned when the move was successful, false is returned when the move as not valid 
     *          and thus not successful
     * @returns true if the move was valid and successful
     */
    @Override
    public boolean move(String first, String second, String direction) {
        Player currentPlayer = this.players[current];
        int noncurrent = (current + 1) % NUMBER_PLAYERS;
        Player opponent = this.players[noncurrent];
        String move = first + "," + second + "," + direction;
    ...
    /**
     * This method makes a move for the ComputerPlayer.
     */
    public void moveComputer() {
        String choice = this.players[current].determineMove(this.getBoard(), this.getOpponentPlayer(), "");
        String[] array = choice.split(",");
        String first = array[0];
        String second = array[1];
        String destination = array[2];
        this.move(first, second, destination);
    }
     ...
     * @return a string containing a hint for a human player
     */
    @Override
    public String hint() {
    ...
    /**
     * This method gives back a string with the current points per player in the game.
     * 
    ...
    /**
     * This method gives back the result when the game has ended as a string.
     * 
     ...
     * 
     * @ensures the String with the print of the result of the game, conform to protocol, is returned
    ...
    /**
     * Method which prints out the game result. We access this method from the server to let the server also print out 
     * the fact that the game has ended.
     */
    @Override
    ...
    /**
     * This method gives back the current as an integer.
     * 
     * @ensures an integer of either 0 or 1 to be returned
     * @return current
     */
    @Override
    ...
    /**
     * This method gives back the current player.
     * 
    ...
    /**
     * This method gives back the string version of the marble from a player with
     * index i on the array players.
     * 
     * @requires i either 0 or 1
     * @param i integer
    ...
    /**
     * This method gives back the board of the game.
     * 
